# <div align="center"><img src="screenshots/images/logo96.png" style="top:-20px;" height="60">&nbsp;<img src="screenshots/images/titleMultinavigator.svg" height="50"></div>
...
**TRADEMARK NOTICE:**  
"MultiNavigator" is a name and brand used continuously in commerce since **2001** by its original author, with prior use rights established and documented through registration in the **Intellectual Property Registry of Spain** (registration predating Firefox and Chrome). This prior use constitutes the basis for trademark protection under applicable law.

The Mozilla Public License 2.0 (MPL v2.0) granted for the source code of this software does not transfer, sublicense, or grant any rights to use the name "MultiNavigator", its logos, or its visual identity. Specifically:

- Any fork or derivative work **must be released under a different name**.
- Redistribution of compiled binaries or installers **under the name "MultiNavigator"** is strictly prohibited without written authorization from the original author.
- The original author reserves all rights over the name and brand, independent of the source code license.
