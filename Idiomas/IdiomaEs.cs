...
namespace Multinavigator.Idiomas
{
    ...
    {
        public string Incognito_HTML_Description     => "Escribe una URL o busca algo en la barra de arriba.<br/>Tu actividad no se guardará en este dispositivo.";
        public string Incognito_HTML_Header          => "Nueva pestaña de incógnito";
        public string Incognito_HTML_Title           => "Incógnito";
