...
namespace Multinavigator.Idiomas
{
    ...
    {
        public string Incognito_HTML_Description     => "উপরের বারে একটি URL টাইপ করুন বা কিছু খুঁজুন।<br/>আপনার কার্যকলাপ এই ডিভাইসে সংরক্ষিত হবে না।";
        public string Incognito_HTML_Header          => "নতুন ছদ্মবেশী ট্যাব";
        public string Incognito_HTML_Title           => "ছদ্মবেশী";
