// Resources/IdiomaTr.cs
namespace Multinavigator.Idiomas
{
    internal class IdiomaTr : IIdiomaStrings
    {
        public string Incognito_HTML_Description     => "Yukarıdaki çubuğa bir URL yazın veya bir şey arayın.<br/>Etkinliğiniz bu cihaza kaydedilmeyecek.";
        public string Incognito_HTML_Header          => "Yeni gizli sekme";
        public string Incognito_HTML_Title           => "Gizli";
        public string About_Github            => "GitHub'daki kodu görüntüle";
        public string About_Github_button             => "⭐ GitHub'da yıldız ver";
        public string Theme_ColorDarkWebContent      => "Karanlık modda web içeriği";
        public static readonly IdiomaTr Instance = new();
        // =============================================
        // CONFIGURACION
        // =============================================
