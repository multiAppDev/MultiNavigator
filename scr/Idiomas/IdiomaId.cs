...
namespace Multinavigator.Idiomas
{
    ...
    {
        public string Incognito_HTML_Description     => "Ketik URL o cari sesuatu di bilah atas.<br/>Aktivitas Anda tidak akan disimpan di perangkat ini.";
        public string Incognito_HTML_Header          => "Tab penyamaran baru";
        public string Incognito_HTML_Title           => "Penyamaran";
