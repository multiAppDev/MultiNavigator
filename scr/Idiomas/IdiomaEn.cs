...
namespace Multinavigator.Idiomas
{
    ...
    {
        public string Incognito_HTML_Description     => "Type a URL or search for something in the bar above.<br/>Your activity will not be saved on this device.";
        public string Incognito_HTML_Header          => "New incognito tab";
