...
namespace Multinavigator.Idiomas
{
    ...
    {
        public string Incognito_HTML_Description     => "Digita un URL o cerca qualcosa nella barra in alto.<br/>La tua attività no verrà salvata su questo dispositivo.";
        public string Incognito_HTML_Header          => "Nuova scheda in incognito";
        public string Incognito_HTML_Title           => "Incognito";
