...
namespace Multinavigator.Idiomas
{
    ...
    internal interface IIdiomaStrings
    {
        ...
        // THEMEEDITOR
        string Incognito_HTML_Description { get; }
        string Incognito_HTML_Header { get; }
        string Incognito_HTML_Title { get; }
    ...
    public class Idioma : INotifyPropertyChanged
    {
        ...
        // ── THEMEEDITOR ──
        public string Incognito_HTML_Description => _L.Incognito_HTML_Description;
        public string Incognito_HTML_Header => _L.Incognito_HTML_Header;
        public string Incognito_HTML_Title => _L.Incognito_HTML_Title;
